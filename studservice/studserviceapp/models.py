...
class Student(models.Model):
    ...
    slika = models.ImageField(upload_to='djangouploads')
...
class Predmet(models.Model):
    ...
    """profesor ima listu predmeta, treba dodati listu grupa kojima predaje, svaki predmet treba da ima grupu kojoj pripada(many to many veza)
    i onda pitamo da li predmet iz liste predmeta profesora za dati semestar sa svojom grupom postoji u grupama kojima drzi profesor
    ako postoji grupa se doda u niz i na kraju se i taj predmet doda, i tako za svaki"""
...
class IzbornaGrupa(models.Model):
    ...
    def __str__(self):
        return "Grupa " + self.oznaka_grupe + ", " + str(self.oznaka_semestra) + ". semestar"
